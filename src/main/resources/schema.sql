DROP TABLE IF EXISTS film_genre, film_mpa, friendship, user_film_like, film_director,
directors, genres, mpas, users, films;
...
CREATE TABLE IF NOT EXISTS film_director (
                                           ...
                                           director_id INT NOT NULL REFERENCES directors(id) ON DELETE CASCADE ON UPDATE NO ACTION
